            ...
            <div className="w-9/12 m-auto py-16 min-h-screen flex px-2 items-center justify-center">
                <div className="bg-white shadow overflow-hidden sm:rounded-lg pb-8">
                    <div className="border-t border-gray-200 text-center pt-8">
                        ...
                        <h1 className="text-4xl font-medium py-8 text-green-900">Page not found</h1>
                        <p className="text-md pb-8 px-12 font-medium text-gray-800">Oops! The page you are looking for does not exist. <br /> It might have been moved or deleted.</p>
                        <Link 
                            to='/'
